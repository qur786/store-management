...
<link href="order_history.css" rel="stylesheet">
...
<div>
    <div class="heading"><p>Your Order History</p></div>
        <!--order Data table -->
...
<?php
    ...
    $sql="SELECT *
            ...
            INNER JOIN product_table ON order_table.PRODUCT_ID = product_table.PRODUCT_ID) where order_table.USER_ID='$_SESSION[userid]';";

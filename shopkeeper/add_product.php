...
<div class="form_div">
    <form id="form1" method="POST" enctype="multipart/form-data">
        ...
        <br>
        <input type="text" class="form_control" name="productname" id="name" required>
        <br><br>
        <label>Brand</label>
        <br>
        <input type="text" class="form_control" name="productbrand" id="name" required>
        <br><br>
        <label>Quantity</label>
        <br>
        <input type="number" class="form_control" name="productquantity" id="name" required>
        <br><br>
        <label>Price (&#8377;)</label>
        <br>
        <input type="number" class="form_control" name="productprice" id="name" required>
        <br><br>
        <label>Descriptions</label>
        <br>
        <textarea class="desc" name="productdescription" id="name" required></textarea>
        <br><br>

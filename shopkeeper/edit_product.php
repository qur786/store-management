    ...
    <div class="form_div">
        <form id="form1" method="" action="">
             <h4 font-family="sans-serif">Edit Product Details</h4><br>
                ...
                <input type="textbox" value="<?php echo $productbrand; ?>" class="form_control" name="productbrand" id="productbrand" readonly required>
                <br><br>
                <label>Quantity</label><br>
                <input type="textbox" value="<?php echo $productquantity; ?>" class="form_control" name="productquantity" id="productquantity" readonly required>
                <br><br>
                <label>Price (&#8377;)</label><br>
                <input type="textbox" value="<?php echo $productprice; ?>" class="form_control" name="productprice" id="productprice" readonly required>
                <br><br>
